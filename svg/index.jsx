...
export function Expert({ width, height, color }) {
  return (
    <svg
      width={width}
      height={height}
...
export function Facebook({ size, color }) {
  return (
    ...
    >
      <path
        d="M309.607 30C311.264 30 312.607 31.3432 312.607 33V99.6786C312.607 101.335 311.264 102.679 309.607 102.679H261.536C250.49 102.679 241.536 111.633 241.536 122.679V175.357H315.287C317.265 175.357 318.701 177.238 318.181 179.146L299.996 245.825C299.64 247.13 298.454 248.036 297.101 248.036H241.536V397C241.536 398.657 240.193 400 238.536 400H171.857C170.2 400 168.857 398.657 168.857 397L168.857 248.036H114C112.343 248.036 111 246.693 111 245.036V178.357C111 176.7 112.343 175.357 114 175.357H168.857L168.857 100C168.857 61.3401 200.197 30 238.857 30H309.607Z"
        fill="#4BB3FD"
      />
      <g style={{ mixblendMode: "multiply" }} opacity="0.4">
        <path
          d="M203.857 400V248.036H168.857L168.857 397C168.857 398.657 170.2 400 171.857 400H203.857Z"
          fill={color}
        />
        <path
          d="M146 248.036V175.357H114C112.343 175.357 111 176.7 111 178.357V245.036C111 246.693 112.343 248.036 114 248.036H146Z"
          fill={color}
        />
        <path
          d="M168.857 175.357H203.857L203.857 100C203.857 61.3401 235.197 30 273.857 30H238.857C200.197 30 168.857 61.3401 168.857 100L168.857 175.357Z"
          fill={color}
        />
      </g>
    </svg>
...
export function Category({ size, color }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ImageIcon({ size, color }) {
  return (
    <svg
      fill={color}
      width={size}
