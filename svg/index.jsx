...
export function Brain({ width, height, color }) {
  return (
    <svg
      version="1.1"
      id="Icons"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path d="M12.5,28c-1.2,0-2.3-0.9-2.5-2.2C10,25.4,9.6,25,9.1,25C6.8,24.8,5,22.8,5,20.5c0-0.8,0.2-1.5,0.6-2.2C6.5,18.7,7.5,19,8.5,19c0.6,0,1-0.4,1-1s-0.4-1-1-1c-1,0-1.8-0.3-2.6-0.8c0,0,0,0-0.1-0.1c-0.3-0.2-0.5-0.4-0.8-0.7C5.1,15.4,5,15.3,5,15.3c-0.1-0.1-0.2-0.3-0.3-0.4c-0.1-0.2-0.2-0.3-0.3-0.5c0-0.1-0.1-0.1-0.1-0.2c-0.1-0.2-0.2-0.5-0.2-0.7c0,0,0-0.1,0-0.1C4,13.1,4,12.8,4,12.5C4,10.1,5.9,8.1,8.3,8C8.6,8.8,9,9.4,9.6,9.9c0.2,0.2,0.4,0.2,0.6,0.2c0.3,0,0.6-0.1,0.8-0.4c0.4-0.4,0.3-1.1-0.1-1.4C10.3,7.9,10,7.2,10,6.5C10,5.1,11.1,4,12.5,4S15,5.1,15,6.5v19C15,26.9,13.9,28,12.5,28z M22.9,25c-0.5,0-0.8,0.4-0.9,0.9c-0.2,1.2-1.2,2.2-2.5,2.2c-1.4,0-2.5-1.1-2.5-2.5v-19C17,5.1,18.1,4,19.5,4S22,5.1,22,6.5V7c0,0.3,0.1,0.5,0.3,0.7s0.5,0.3,0.8,0.3c0.1,0,0.3,0,0.4,0C26,8,28,10,28,12.5c0,1.4-0.6,2.6-1.7,3.5c-0.9-0.6-2.1-1-3.3-1c-0.6,0-1,0.4-1,1s0.4,1,1,1c2.1,0,3.8,1.7,4,3.8C26.8,23,25.1,24.8,22.9,25z"></path>
      </g>
    </svg>
  );
}
...
export function StarFill({ width, height, color }) {
  return (
    <svg
      fill={color}
      width={width}
...
export function Virus({ width, height, color }) {
  return (
    <svg
      className="w-[300px]"
      height={height}
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g id="Layer_2" dataName="Layer 2">
          ...
          <g id="Layer_4" data-name="Layer 4">
            {" "}
            <path d="M44.5,22.1l-4.7-1.4a3.7,3.7,0,0,1-2.5-2.2,3.5,3.5,0,0,1,.2-3.3l2.4-4.4a2.1,2.1,0,0,0-.3-2.4,2.1,2.1,0,0,0-2.4-.3l-4.4,2.4a3.5,3.5,0,0,1-3.3.2,3.7,3.7,0,0,1-2.2-2.5L25.9,3.4a2,2,0,0,0-3.8,0L20.7,8.2a3.7,3.7,0,0,1-2.2,2.5,3.5,3.5,0,0,1-3.3-.2L10.8,8.1a2.1,2.1,0,0,0-2.4.3,2.1,2.1,0,0,0-.3,2.4l2.4,4.4a3.5,3.5,0,0,1,.2,3.3,3.7,3.7,0,0,1-2.5,2.2L3.5,22.1a2,2,0,0,0,0,3.8l4.7,1.4a3.7,3.7,0,0,1,2.5,2.2,3.5,3.5,0,0,1-.2,3.3L8.1,37.2a2.1,2.1,0,0,0,.3,2.4,2.1,2.1,0,0,0,2.4.3l4.4-2.4a3.5,3.5,0,0,1,3.3-.2,3.5,3.5,0,0,1,2.2,2.5l1.4,4.8a2,2,0,0,0,3.8,0l1.4-4.8a3.8,3.8,0,0,1,5.5-2.3l4.4,2.4a2,2,0,0,0,2.7-2.7l-2.4-4.4a3.5,3.5,0,0,1-.2-3.3,3.7,3.7,0,0,1,2.5-2.2l4.7-1.4a2,2,0,0,0,0-3.8ZM21,25a4,4,0,1,1,4-4A4,4,0,0,1,21,25Zm8,6a2,2,0,1,1,2-2A2,2,0,0,1,29,31Z"></path>{" "}
          </g>{" "}
        </g>{" "}
      </g>
    </svg>
...
export function Marker({initialWidth,height,color,top,left}){
