  ...
  return (
    <section className="flex mt-5" >
        <div className="flex flex-col justify-center items-center gap-3 w-1/2">
            <h1 className="font-bold text-5xl mb-0">Un apprentissage illimité à portée
        ...
        <div className='w-1/2 flex items-center justify-center'>
            <div className='rounded-full w-[600px] h-[600px] flex justify-center items-end overflow-hidden' style={{backgroundColor : '#1D3B53'}}>
                <Image src={'/photo/couv.png'} width={450} height={450} alt='couv' className='mb-2.5'/>
            </div>
        </div>
    </section>
  )
